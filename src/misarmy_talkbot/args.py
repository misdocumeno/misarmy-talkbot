...
parser.add_argument(
    '--log-level',
    default='INFO',
    help=f'Logging level [{"|".join(choices)}]',
    choices=choices,
)
parser.add_argument(
    '--dev-guild',
    default=DEFAULT_DEV_GUILD,
    help='Guild with command for syncing global slash commands.',
)
parser.add_argument(
    '--invite-guild',
    default=DEFAULT_DEV_GUILD,
    help='Guild id for the invite command.',
)
